 ...
 * generated in the com.ikang.webservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetAuthorByName_QNAME = new QName("http://www.ikang.com/webservice", "getAuthorByName");
    private final static QName _GetAuthorByNameResponse_QNAME = new QName("http://www.ikang.com/webservice", "getAuthorByNameResponse");
    private final static QName _GetAuthorList_QNAME = new QName("http://www.ikang.com/webservice", "getAuthorList");
    private final static QName _GetAuthorListResponse_QNAME = new QName("http://www.ikang.com/webservice", "getAuthorListResponse");
    private final static QName _GetAuthorString_QNAME = new QName("http://www.ikang.com/webservice", "getAuthorString");
    private final static QName _GetAuthorStringResponse_QNAME = new QName("http://www.ikang.com/webservice", "getAuthorStringResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ikang.webservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.ikang.com/webservice", name = "getAuthorByName")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.ikang.com/webservice", name = "getAuthorByNameResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.ikang.com/webservice", name = "getAuthorList")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.ikang.com/webservice", name = "getAuthorListResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.ikang.com/webservice", name = "getAuthorString")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.ikang.com/webservice", name = "getAuthorStringResponse")
